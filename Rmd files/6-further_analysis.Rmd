...
sal.res <- data.frame(read.csv("../salamander-eye-size-master/Data/salamanders_residuals_binary.csv", header=TRUE, na.strings=c("", "NA", " ","<1")))
sal.res.2 <- data.frame(read.csv("../salamander-eye-size-master/Data/salamanders_residuals_updated.csv", header=TRUE, na.strings=c("", "NA", " ", "<1")))
aquaticspecies <- data.frame(read.csv("../salamander-eye-size-master/Data/aquaticspecies.csv", header=TRUE, na.strings=c("", "NA", " ", "<1")))
...
#define a colorblind-friendly vector of colors for adult habitat
col_dev <- c("direct developmnent" = "chartreuse3",
